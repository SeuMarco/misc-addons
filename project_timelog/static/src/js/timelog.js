$(document).ready(function() {
    ...
    "use strict";
    var TimeLog = odoo.TimeLog = {};
    var audio = new Audio();
    var instance = odoo;

    TimeLog.Manager = odoo.Widget.extend({
        ...
        received_message: function(message) {
            ...
            if (message.status == "stop") {
                ...
                if (!message.play_a_sound && !message.stopline) {
                    ...
                    audio.src = odoo.session.url("/project_timelog/static/src/audio/" + "stop" + this.audio_format);
                    audio.play();
                }
    ...
    TimeLog.TimelogWidget = odoo.Widget.extend({
        ...
        ClientOffLine: function() {
            ...
            audio.src = odoo.session.url("/project_timelog/static/src/audio/"+"stop"+ self.audio_format);
        ...
        load_server_data: function() {
            ...
            this.rpc("/timelog/upd", {}).then(function(resultat){
                ...
                self.c_manager = new odoo.TimeLog.Manager(self);
            });
        },
        ...
        timerTimeLimited: function() {
            ...
            var model = new odoo.web.Model('project.task.work');
        ...
        playAudio: function(id) {
            ...
            audio.src = odoo.session.url("/project_timelog/static/src/audio/"+id+ this.audio_format);
            audio.play();
        },
        ...
        timer_pause: function() {
            var self = this;
            var model_subtask = new odoo.web.Model('project.task.work');
